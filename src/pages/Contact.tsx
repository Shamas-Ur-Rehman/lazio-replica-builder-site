        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div>
            <form className="bg-white/80 glass-morphism p-8 rounded-2xl shadow-2xl animate-scale-in border border-lazioBlue/20 backdrop-blur-md">
              ...
              <div className="mb-4">
                <Label className="block mb-1 text-gray-700 font-medium" htmlFor="name">Full Name</Label>
                <Input id="name" className="w-full" type="text" placeholder="Your name" required />
              </div>
              
              <div className="mb-4">
                <Label className="block mb-1 text-gray-700 font-medium" htmlFor="email">Email Address</Label>
                <Input id="email" className="w-full" type="email" placeholder="Your email" required />
              </div>
              
              <div className="mb-4">
                <Label className="block mb-1 text-gray-700 font-medium" htmlFor="phone">Phone Number</Label>
                <Input id="phone" className="w-full" type="tel" placeholder="Your phone number" />
              </div>
              
              <div className="mb-4">
                <Label className="block mb-1 text-gray-700 font-medium" htmlFor="subject">Subject</Label>
                <Input id="subject" className="w-full" type="text" placeholder="How can we help?" required />
              </div>
            ...
            <div className="bg-lazioGray/80 glass-morphism p-8 rounded-2xl h-full shadow-xl animate-slide-in-right border border-lazioBlue/10 backdrop-blur-sm">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="mr-4 text-lazioBlue">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-lazioBlue hover:text-lazioDarkBlue transition-colors">
