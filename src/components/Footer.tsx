...
const Footer: React.FC = () => {
  return (
    <footer className="bg-lazioDarkBlue text-white pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Cantilever Racking</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Mezzanine Floors</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Safety Inspections</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Consultancy</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@lazioracking.com</span>
              </li>
            </ul>
          </div>
        </div>
