        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Configure your industrial storage system with our easy-to-use
              builder. Get a personalized quote for your specific needs.
            </p>
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <Button
                variant="outline"
                className="border-lazioBlue text-lazioBlue hover:bg-lazioBlue hover:text-white"
              >
                Contact Sales
              </Button>
            </div>
